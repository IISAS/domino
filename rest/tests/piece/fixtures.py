...
def get_pieces_mock_response(piece_repository: PieceRepository):
    mock_response = [
        GetPiecesResponse(
            ...
            repository_url='https://github.com/IISAS/default_domino_pieces_tests',
            source_url='https://github.com/IISAS/default_domino_pieces_tests/tree/main/pieces/SimpleLogPiece',
            source_image = "ghcr.io/iisas/default_domino_pieces_tests:0.0.9-group0",
            input_schema = {
