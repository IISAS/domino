...
class K8sSettings(Settings):
    ...
    CORS: dict = {
        "origins": [
            ...
            "http://147.213.76.237",
            "http://147.213.76.237/",
            "http://147.213.76.237:8000",
            "http://147.213.76.237:8000/",
            "http://147.213.76.237:8000/domino",
            "http://147.213.76.237:8000/domino/",
            "http://domino-frontend-service",
            "http://domino-frontend-service/",
            "http://domino-frontend-service:80",
            "http://domino-frontend-service:80/",
            "http://domino-frontend-service:80/domino",
            "http://domino-frontend-service:80/domino/",
            "http://domino-frontend-service:8000",
            "http://domino-frontend-service:8000/",
            "http://domino-frontend-service:8000/domino",
            "http://domino-frontend-service:8000/domino/",
        ],
        "allow_credentials": True,
        "allow_methods": ["*"],
