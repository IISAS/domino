...
flowui_backend = {
    ...
    "environment": [
        ...
        "DOMINO_GIT_ACCESS_TOKEN_PIECES=${DOMINO_GIT_ACCESS_TOKEN_PIECES}",
        "DOMINO_GIT_ACCESS_TOKEN_WORKFLOWS=${DOMINO_GIT_ACCESS_TOKEN_WORKFLOWS}",
        "DOMINO_GIT_WORKFLOWS_REPOSITORY=${DOMINO_GIT_WORKFLOWS_REPOSITORY}",
